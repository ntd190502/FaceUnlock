...
- Build the Setup artifact and verify its installer staging contents contain Agent, Service, Shell, Shell Gate scripts, diagnostics, and migration cleanup, with no retired DLL or enable/disable script.
