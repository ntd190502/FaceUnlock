...
public class Program
{
    public static async Task<int> Main(string[] args)
    {
        ...
        var engine1 = new ShellEngine(ShellMode.Shell, pipeName: "FaceUnlock.NonExistent.Pipe", launcher: launcher1, customLogFile: customLog);
        ...
        try
        {
            ...
            var engine2 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher2, customLogFile: customLog);
            ...
            var engine3 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher3, customLogFile: customLog);
            ...
            var engine4 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher4, customLogFile: customLog);
            ...
            var engine5 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher5, customLogFile: customLog);
            ...
            var engine6 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher6, customLogFile: customLog);
            ...
            var engine8 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher8, customLogFile: customLog);
            ...
            bool launched8 = engine8.LaunchExplorerSafe();
            ...
            var engine10 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher10, customLogFile: customLog);
            ...
            var engine15 = new ShellEngine(ShellMode.Shell, pipeName: testPipe, launcher: launcher15, customLogFile: customLog);
