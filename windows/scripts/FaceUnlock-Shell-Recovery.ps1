...
.DESCRIPTION
    ...
    This offline/administrative recovery disables the Shell Gate intentionally.
    Normal-session Task Manager Explorer launch is denied by the Phase F.2 watchdog.
